...
export function BackgroundTaskIndicator() {
    ...
    const activeDAGs = Object.values(inlineDAGs).filter((d) => d.status === 'dispatched' || d.status === 'running');
    ...
    return (<div className="flex items-center gap-2 rounded-full bg-blue-500/10 px-3 py-1">
...
//# sourceMappingURL=BackgroundTaskIndicator.js.map