...
export function DAGVisualization() {
    ...
    return (<ReactFlow nodes={rfNodes} edges={rfEdges} onNodesChange={onNodesChange} onEdgesChange={onEdgesChange} onNodeClick={onNodeClick} nodeTypes={nodeTypes} fitView proOptions={{ hideAttribution: true }} className="bg-zinc-950">
      ...
      <MiniMap nodeColor={(node) => {
            ...
            if (status === 'error')
                return '#ef4444';
            return '#3f3f46';
        }} maskColor="rgba(0,0,0,0.7)" className="!bg-zinc-900 !border-zinc-700"/>
    </ReactFlow>);
}
//# sourceMappingURL=DAGVisualization.js.map