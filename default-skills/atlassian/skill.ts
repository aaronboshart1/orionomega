...
export default class AtlassianSkill extends BaseSkill {
  ...
  getTools(): SkillTool[] {
    ...
    if (this.enabledProducts.has('jira')) {
      tools.push({
        name: 'atlassian_jira',
        description:
    ...
    if (this.enabledProducts.has('confluence')) {
      tools.push({
    ...
    if (this.enabledProducts.has('compass')) {
      tools.push({
    ...
    if (this.enabledProducts.has('jsm')) {
      tools.push({
        name: 'atlassian_jsm',
        description:
    ...
    if (this.enabledProducts.has('bitbucket')) {
      tools.push({
    ...
    if (this.enabledProducts.has('search')) {
      tools.push({
